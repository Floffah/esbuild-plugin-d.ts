...
import { logDeclarationOutputs } from "@/lib/logDeclarationOutputs";
    ...
    ({
        ...
        async setup(build) {
            ...
            build.onEnd(() => {
                ...
                let outputFiles = emitResult.emittedFiles;
                ...
                if (emitResult.emitSkipped || typeof outputFiles === "undefined") {
                    log.info(chalk`{yellow No declarations emitted}`);
                } else {
                    logDeclarationOutputs(
                        log,
                        outputFiles,
